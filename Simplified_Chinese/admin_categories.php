...
// 在 admin_categories.php 中使用的语言定义
$lang_admin_categories = array(

'Must enter name message'     => '您必须输入类别名称。',
'Category added redirect'     => '类别已添加。正在重定向…',
'Category deleted redirect'   => '类别已删除。正在重定向…',
'Delete category head'        => '删除类别（包括其中的所有论坛和帖子）',
...
'Delete categories head'      => '删除类别',
'Delete categories subhead'   => '删除类别',
'Delete category label'       => '删除类别',
'Delete category help'        => '选择您想要删除的类别名称。在删除之前，您将被要求确认您选择的类别。',
